...
const Button = ({
  ...
  if (typeof iconType === 'string') {
    iconEl = <Icon aria-hidden="true" name={iconType} size={size} className={`${prefixCls}-icon`} />;
  } else if (iconType) {
  ...
  return (
    <button className={wrapCls} {...restProps} onClick={disabled ? undefined : onClick} aria-disabled={disabled}>
      {iconEl}
      {kids}
    </button>
  );
