...
class Modal extends Component {
    ...
    render() {
        ...
        return (
            <CSSTransition in={showDialog} classNames="modal-wrapper" timeout={this.transitionTime}>
                <div className="modal">
                    <CSSTransition in={showDialog} classNames="dialog-wrapper" timeout={this.transitionTime}>
